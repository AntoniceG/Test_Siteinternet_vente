                ...
                {steps.map((step, index) => (
                    <Card key={index} className="bg-zinc-900 border-zinc-800">
                        <CardContent className="p-8 flex flex-col gap-6">
                            <div className="w-12 h-12 bg-emerald-500 text-zinc-950 rounded-xl flex items-center justify-center font-bold text-xl">
                                {step.number}
                            </div>
                            <h3 className="font-text-xl-font-semibold text-neutral-50">
                                {step.title}
                            </h3>
                            <p className="font-text-base-font-normal text-zinc-400">
                                {step.description}
                            </p>
                        </CardContent>
                    </Card>
